...
def uploadImage(key, new_height=480):
    ...
    return cv2.cvtColor(preProcessImg(cv2.imread('sample.png'),new_height),cv2.COLOR_BGR2RGB)

# About Me UI 

def aboutMe():
    
    st.markdown(requests.get(os.getenv('ABOUT_ME','https://raw.githubusercontent.com/keshav1508/keshav1508/main/README.md')).text, unsafe_allow_html=True)
